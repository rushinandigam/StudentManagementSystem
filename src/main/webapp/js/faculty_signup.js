...
window.onload = () => {
    attachBlurValidation("facultyId", patterns.facultyId, "Invalid format (e.g., CS101)");
...
function validateFacultySignupForm() {
    const inputs = {
    ...
    const validations = [
        { id: "facultyId", valid: patterns.facultyId.test(inputs.facultyId), msg: "Invalid faculty ID format" },
    ...
    if (!inputs.experience || inputs.experience < 0) {
